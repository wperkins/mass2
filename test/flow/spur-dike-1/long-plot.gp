...
# Last Change: Fri Apr  2 09:55:28 2004 by William A. Perkins <perk@leechong.pnl.gov>
# -------------------------------------------------------------
...
set title "y/b = 1.0"
set output 'long-1.0.eps'
plot '<perl ../../../scripts/mass2slice.pl -i -l plot.nc vmag 1 8' using (xob($3)):($4/u) title 'Simulated' with lines 1, \
...
set title "y/b = 1.5"
set output 'long-1.5.eps'
plot '<perl ../../../scripts/mass2slice.pl -i -l plot.nc vmag 1 12' using (xob($3)):($4/u) title 'Simulated' with lines 1, \
...
set output 'long-2.0.eps'
set title "y/b = 2.0"
plot '<perl ../../../scripts/mass2slice.pl -i -l plot.nc vmag 1 15' using (xob($3)):($4/u) title 'Simulated' with lines 1, \
...
set output 'long-3.0.eps'
set title "y/b = 3.0"
plot '<perl ../../../scripts/mass2slice.pl -i -l plot.nc vmag 1 23' using (xob($3)):($4/u) title 'Simulated' with lines 1, \
...
set output 'long-4.0.eps'
set title "y/b = 4.0"
plot '<perl ../../../scripts/mass2slice.pl -i -l plot.nc vmag 1 30' using (xob($3)):($4/u) title 'Simulated' with lines 1, \
