...
set tmargin -1
set locale "C"
plot '<perl ../../../scripts/mass2slice.pl -i -l plot.nc depth 1 10' using ($1*0.3048):($4*0.3048) title 'Simulated' with lines 1,'observed/streamline5d.obs.dat' title 'Observed' with points 7
#    EOF
