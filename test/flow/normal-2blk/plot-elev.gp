...
# Last Change: Tue Nov 25 08:24:19 2003 by William A. Perkins <perk@leechong.pnl.gov>
# -------------------------------------------------------------
# $Id$
...
plot '<perl ../../../scripts/mass2slice.pl -t 1 -i plot.nc wsel 1 5 2 5' using 3:4 title 'Initial Conditions' with linespoints 1, \
     ...
     '<perl ../../../scripts/mass2slice.pl -i plot.nc zbot 1 5 2 5' using 3:4 title 'Bottom' with lines 7
