...
# Last Change: Wed Jul  5 11:19:44 2000 by William A. Perkins <perk@dora.pnl.gov>
# -------------------------------------------------------------
# $Id$
...
plot '<perl ../../../scripts/mass2slice.pl -t 1 -i plot.nc wsel 1 5 2 5' using 3:4 title 'Initial Conditions' with linespoints 1, \
     '<perl ../../../scripts/mass2slice.pl -t 2 -i plot.nc wsel 1 5 2 5' using 3:4 title 'Steady State' with linespoints 3, \
