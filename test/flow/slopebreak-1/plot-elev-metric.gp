...
# Last Change: Wed May 11 07:23:26 2011 by William A. Perkins <d3g096@bearflag.pnl.gov>
# -------------------------------------------------------------
# $Id$
...
plot '<perl ../../../scripts/mass2slice.pl -t 1 -i plot.nc wsel 1 5' using ($3*0.3048):($4*0.3048) title 'Initial Conditions' with lines ls 3, \
     '<perl ../../../scripts/mass2slice.pl -l -i plot.nc wsel 1 5' using ($3*0.3048):($4*0.3048) title 'Steady State' with linespoints ls 1, \
