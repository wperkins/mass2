...
# Last Change: Fri May 16 08:37:15 2003 by William A. Perkins <perk@leechong.pnl.gov>
# -------------------------------------------------------------
# $Id$
...
plot '<perl ../../../scripts/mass2slice.pl -t 1 -i plot.nc wsel 1 5 2 10 3 5' using 3:4 title 'Initial Conditions' with linespoints 1, \
     ...
     '<perl ../../../scripts/mass2slice.pl -i plot.nc zbot 1 5 2 10 3 5' using 3:4 title 'Bottom' with linespoints 7