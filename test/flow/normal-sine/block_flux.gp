...
#    	System: Linux 2.6.9-89.0.20.ELsmp
#    
...
plot "<awk '$3 == 1' block_flux.out" using 1:5 title "Block 1 DS" with linesp, "<awk '$3 == 2' block_flux.out" using 1:4 title "Block 2 US" with lines 3
#    EOF
