...
plot '<perl ../mixing/solution.pl -x 2020' using 2:3 title 'Analytic (x = 2020)' with lines ls 1, \
     '<perl ../../../scripts/mass2slice.pl -i -l plot.nc stuff 1 52' using 3:4 title "Numerical (y = 2020)" with points ls 1, \
     '<perl ../mixing/solution.pl -x 3020' using 2:3 title 'Analytic (y = 3020)' with lines ls 3, \
     '<perl ../../../scripts/mass2slice.pl -i -l plot.nc stuff 1 77' using 3:4 title "Numerical (y = 3020)" with points ls 3
