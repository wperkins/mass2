...
plot C(x, 360.0) title "Analytic: t = 6.0 min", \
     ...
     '< perl ../../../scripts/mass2slice.pl -j -t 12 plot.nc stuff 1 6 2 6 3 6' using 3:4 title 'Simulated' with points 7, \
     '< perl ../../../scripts/mass2slice.pl -j -t 14 plot.nc stuff 1 6 2 6 3 6' using 3:4 notitle with points 7, \
     '< perl ../../../scripts/mass2slice.pl -j -t 16 plot.nc stuff 1 6 2 6 3 6' using 3:4 notitle with points 7, \
     '< perl ../../../scripts/mass2slice.pl -j -t 18 plot.nc stuff 1 6 2 6 3 6' using 3:4 notitle with points 7, \
     '< perl ../../../scripts/mass2slice.pl -j -t 20 plot.nc stuff 1 6 2 6 3 6' using 3:4 notitle with points 7
