...
plot '<perl solution.pl -x 525' using ($2*0.3048):3 title 'Analytic (x = 160)' with lines ls 1, \
     ...
     '<perl ../../../scripts/mass2slice.pl -j -l plot.nc stuff 1 22' using ($3*0.3048):4 notitle with points ls 7, \
     '<perl ../../../scripts/mass2slice.pl -j -l plot.nc stuff 1 12' using ($3*0.3048):4 title "Simulated" with points ls 7, \
     '<perl ../../../scripts/mass2slice.pl -j -l plot.nc stuff 1 42' using ($3*0.3048):4 notitle with points ls 7, \
     '<perl ../../../scripts/mass2slice.pl -j -l plot.nc stuff 1 102' using ($3*0.3048):4 notitle with points ls 7
