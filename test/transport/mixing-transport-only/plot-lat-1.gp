...
plot '<perl ../mixing/solution.pl -x 420' using 2:3 title 'Analytic (x = 420)' with lines ls 1, \
     '<perl ../../../scripts/mass2slice.pl -j -t 2 plot.nc stuff 1 12' using 3:4 title "Numerical (y = 420)" with points ls 1, \
     '<perl ../mixing/solution.pl -x 1020' using 2:3 title 'Analytic (y = 1020)' with lines ls 3, \
     '<perl ../../../scripts/mass2slice.pl -j -t 2 plot.nc stuff 1 27' using 3:4 title "Numerical (y = 1020)" with points ls 3
