...
plot '<perl ../mixing/solution.pl -x 2020' using 2:3 title 'Analytic (x = 2020)' with lines 1, \
     '<perl ../../../scripts/mass2slice.pl -j -t 2 plot.nc stuff 2 32' using 3:4 title "Numerical (y = 2020)" with points 1, \
     '<perl ../mixing/solution.pl -x 3020' using 2:3 title 'Analytic (y = 3020)' with lines 3, \
     '<perl ../../../scripts/mass2slice.pl -j -t 2 plot.nc stuff 2 57' using 3:4 title "Numerical (y = 3020)" with points 3
