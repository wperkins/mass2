...
plot '<perl ../mixing/solution.pl -y 22.5' using 1:3 title 'Analytic (y = 22.5)' with lines 1, \
     '<perl ../../../scripts/mass2slice.pl -i -t 2 plot.nc stuff 1 6 2 6' using 3:4 title "Numerical (y = 22.5)" with points 1, \
     '<perl ../mixing/solution.pl -y 77.5' using 1:3 title 'Analytic (y = 77.5)' with lines 3, \
     '<perl ../../../scripts/mass2slice.pl -i -t 2 plot.nc stuff 1 17 2 17' using 3:4 title "Numerical (y = 77.5)" with points 3
