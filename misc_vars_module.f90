...
DOUBLE PRECISION, SAVE :: roughness, species_io_vec(100)

DOUBLE PRECISION, ALLOCATABLE, SAVE :: aa(:),bb(:),cc(:),dd(:),tt(:),ptemp(:),qtemp(:)
DOUBLE PRECISION, ALLOCATABLE, SAVE :: work(:,:),cos_ij(:,:),inlet_area(:),table_input(:)
...
DOUBLE PRECISION, SAVE :: chezy_con_default, slope,ds_elev,z_step
...
INTEGER, SAVE :: x_start			! x line to start scalar calculations (usually = 2)
...
LOGICAL, SAVE :: debug, manning, read_grid
